            ...
            {modal.mode === 'view' ? (
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2.5 text-sm text-[var(--theme-text-muted)] bg-[var(--theme-bg-main)] p-4 rounded-lg border border-[var(--theme-border)]">
                  <div className="flex gap-2.5 items-center"><Clock size={16} className="text-[var(--color-yellow-500)]" /> {modal.form.date} Â· {modal.form.startTime}–{modal.form.endTime}</div>
